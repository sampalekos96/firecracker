...
use self::gicv2::GICv2;
use self::gicv3::GICv3;
// use self::kvm_ioctls::{DeviceFd};
pub use self::regs::GicState;
...
pub enum Error {
    ...
    DeviceAttribute(io::Error, bool, u32),
...
pub trait GICDevice {
    ...
    where
        Self: Sized,
    {
        // println!("Prin tin kvm_device_attr");
        ...
        // println!("Meta tin actual set_device_attr");
        ...
        Self: Sized,
    {
        ...
        // println!("Prin tin finalize_device");
        Self::finalize_device(device.as_ref())?;
        // println!("Meta tin finalize_device");
        Ok(device)
    }
}
